  ...
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="addressList.length > 0">
        <div class="info-content">
          <span class="name">{{ this.addressList[0].username }}</span>
          <span class="mobile">{{ this.addressList[0].tel }}</span>
        </div>
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="this.addressList.length === 0">请先选择配送地址</span>
...
export default {
  ...
  methods: {
    // getAddress () {
    //   this.addressList = this.$store.getters['address/getAddressList']
    // },
    async submitOrder () {
      if (this.mode === 'cart') {
